from scripts.SetExpan.main_fr import *

iter_num = 10  # can initialize until 15, 20, ... no more quality terms will be included after 10 iteration
expanded_taxonomy, seed_taxonomy = runMultiSetExpan(iteration_number=iter_num, lang="fr", threshold_boolean=True,
                                                    debug=False)
# get annotated taxonomy
annotated_taxonomy = annotated_taxonomy(lang="fr")
